<template>
    <div>
        ...
        <CBottomSheet
            ...
            :limit-size="true"
        >
            <CanchaForm :close-modal="closeModal"></CanchaForm>
        </CBottomSheet>
        <!-- END CUSTOM -->
        <CConfirmationDialog
...
import { useCancha } from "../composables/useCancha";
//Controles core
import {
    CCustomPagination,
    CGenerationAction,
...
//Form
import CanchaForm from "../components/CanchaForm.vue";
